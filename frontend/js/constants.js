const contractAddress = "0xf4DbBCC4832Ac741f48eed69424eF30b7E860C20"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Spinoptics Blocks NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Spinoptics Blocks NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection.';
